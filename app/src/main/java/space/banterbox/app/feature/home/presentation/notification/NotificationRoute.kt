...
package space.banterbox.app.feature.home.presentation.notification
...
import space.banterbox.app.feature.home.presentation.landing.UserAvatar
import space.banterbox.app.feature.home.presentation.profile.FullScreenErrorLayout
import space.banterbox.app.ui.theme.Amber40
...
private fun NotificationItem(
    modifier: Modifier = Modifier,
    notification: BanterboxNotification,
        ...
        modifier = modifier
            ...
            .clickable {
                when (notification.type) {
                    BanterboxNotificationType.FOLLOW -> {
                        onUserProfileClick()
                    }
                    BanterboxNotificationType.LIKE -> {
                        onPostClick()
                    }
                    BanterboxNotificationType.GENERAL -> Noop()
                    BanterboxNotificationType.ANNOUNCEMENTS -> Noop()
                    BanterboxNotificationType.UNKNOWN -> Noop()
                }
            }
        ...
        val uiState = NotificationUiState.Success(
            listOf(
                NotificationUiModel.Notification(
                    BanterboxNotification(
                        id = "1",
                        type = BanterboxNotificationType.FOLLOW,
                        subType = null,
                        ...
                        recipientId = "1",
                        actorId = "1",
                        actor = space.banterbox.app.feature.home.domain.model.UserSummary(
                            id = "1",
                            username = "john",
                            displayName = "John",
                            profilePictureId = "",
